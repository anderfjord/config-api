...
Configuration.prototype = {
    ...
    setName: function (name) {
        this.name = name.slice(0, 50);
    },

    setHostname: function (hostname) {
        this.hostname = hostname.slice(0, 50);
    },
    ...
    setUsername: function (username) {
        this.username = username.slice(0, 50);
    },
...
Configuration.getAll = function (params, cb) {
    ...
    console.log('GETTING ALL: ', params);
    ...
    fs.readdir(CONFIGURATION_PATH, function (err, files) {
        ...
        console.log('NO ERROR READING DIR: ', files);
...
Configuration.update = function (name, params, cb) {
    ...
    Configuration.get(name, false, function (err, existingConfig) {
        ...
        if (params.name && params.name !== existingConfig.name) {
            nameHasChanged = true
        }
